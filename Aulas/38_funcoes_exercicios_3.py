...
print('Calculo Stockout {:.2%}'.format(calculo_stockout(vendas)))
...
def identificar_inadimplentes(lista_devedores):
    inadimplentes = []
    total = 0
    for pessoa in lista_devedores:
        cpf, valor, dias = pessoa
        if valor > 1000 and dias > 20:
            inadimplentes.append(cpf)
            total += 1

    return (f'Clientes Inadimplentes {inadimplentes}.\n'
            f'Quantidade de pessoas inadimplentes: {total}')


print(identificar_inadimplentes(clientes_devedores))
