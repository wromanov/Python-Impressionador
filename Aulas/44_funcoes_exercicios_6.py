...
def estoque_unificado(*listas):
    lista_unificada = []
    for lista in listas:  # Percorrer cada lista.
        for produto, estoque in lista:  #
            if produto not in lista_unificada:
                lista_unificada.append(produto)
    return lista_unificada


print(estoque_unificado(estoque_fim_fev, estoque_fim_fev))
print(len(estoque_fim_jan))
print(len(estoque_fim_fev))
